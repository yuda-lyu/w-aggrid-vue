        ...
        <div style="display:flex;">
            ...
            <div>
                ...
                <div style="margin:20px 0px;">
                    <span style="font-size:1.5rem; margin-right:20px;">genRowsPinnBottom</span>
                    <a href="//yuda-lyu.github.io/w-aggrid-vue/examples/ex-genRowsPinnBottom.html" target="_blank" class="item-link item-shadow">example</a>
                    <a href="//github.com/yuda-lyu/w-aggrid-vue/blob/master/docs/examples/ex-genRowsPinnBottom.html" target="_blank" class="item-link item-shadow">code</a>
                </div>
    ...
    data: function() {
        return {
            'opt': {
                ...
                genRowsPinnBottom: function(rows) {
                    // console.log('genRowsPinnBottom', rows)
                    let a1 = 0
                    let a2 = 0
                    let b1 = 0
