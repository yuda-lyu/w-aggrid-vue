...
Add script for ag-grid-community and don't need to include css, because has included them by umd file.
```alias
...
```alias
<script src="https://cdn.jsdelivr.net/npm/w-aggrid-vue@2.0.55/dist/w-aggrid-vue.umd.js"></script>
```
